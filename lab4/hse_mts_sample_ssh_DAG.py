...
t3_bash = f"""
{LINK_HADOOP} jar /usr/local/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.6.jar \
-mapper mapper.py \
-reducer reducer.py \
...
t5_bash = f"{LINK_HDFS} dfs -rm -r /user/hadoop/mapreduce_base_input/* && rm mapper.py && rm reducer.py"
